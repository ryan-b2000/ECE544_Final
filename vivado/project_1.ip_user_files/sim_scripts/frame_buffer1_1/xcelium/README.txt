...
#
# Generated by export_simulation on Wed May 29 15:49:25 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './frame_buffer1.sh' script.

./frame_buffer1.sh -reset_run
...
./frame_buffer1.sh -noclean_files

For more information on the script, please type './frame_buffer1.sh -help'.
