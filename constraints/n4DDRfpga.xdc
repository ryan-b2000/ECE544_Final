...
#et_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { JD[4] }]; #IO_L15P_T2_DQS_35 Sch=jd[7]
#et_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { JD[5] }]; #IO_L20P_T3_35 Sch=jd[8]
