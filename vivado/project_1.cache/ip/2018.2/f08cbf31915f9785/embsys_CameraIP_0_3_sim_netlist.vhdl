...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vga is
  ...
  attribute SOFT_HLUTNM of \hCounter[1]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \hCounter[2]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \hCounter[3]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \hCounter[4]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \hCounter[6]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \hCounter[8]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \hCounter[9]_i_2\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \vCounter[0]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \vCounter[1]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \vCounter[2]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \vCounter[6]_i_2\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \vCounter[8]_i_2\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \vCounter[8]_i_3\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \vCounter[9]_i_2\ : label is "soft_lutpair47";
begin
\address[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAABBAAAAAABF"
    )
        port map (
      I0 => blank_i_2_n_0,
      I1 => hCounter(7),
...
\vCounter[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => vCounter(3),
      I3 => \vCounter[8]_i_3_n_0\,
      I4 => vCounter(4),
      I5 => vCounter(8),
      O => \vCounter[8]_i_1_n_0\
    );
\vCounter[8]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\vCounter[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
