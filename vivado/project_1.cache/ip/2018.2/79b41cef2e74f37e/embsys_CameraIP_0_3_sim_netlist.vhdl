...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vga is
  ...
  signal \vCounter[7]_i_2_n_0\ : STD_LOGIC;
  signal \vCounter[7]_i_3_n_0\ : STD_LOGIC;
  signal \vCounter[7]_i_4_n_0\ : STD_LOGIC;
  ...
  signal vga_hsync_i_5_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \hCounter[1]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \hCounter[2]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \hCounter[3]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \hCounter[4]_i_1\ : label is "soft_lutpair51";
  ...
  attribute SOFT_HLUTNM of \hCounter[8]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \hCounter[9]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \vCounter[0]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \vCounter[1]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \vCounter[2]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \vCounter[3]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \vCounter[4]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \vCounter[6]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \vCounter[6]_i_2\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \vCounter[7]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \vCounter[7]_i_3\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \vCounter[7]_i_4\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \vCounter[8]_i_2\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of vga_hsync_i_2 : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of vga_hsync_i_5 : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of vga_vsync_i_1 : label is "soft_lutpair44";
begin
...
\vCounter[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => vCounter(0),
      I3 => vCounter(2),
      I4 => \vCounter[7]_i_2_n_0\,
      O => \vCounter[7]_i_1_n_0\
    );
\vCounter[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E0E0F0F0404FF0F0"
    )
        port map (
      I0 => vCounter(1),
      I1 => \vCounter[7]_i_3_n_0\,
      I2 => vCounter(7),
      I3 => \vCounter[6]_i_2_n_0\,
      I4 => vCounter(5),
      I5 => \vCounter[7]_i_4_n_0\,
      O => \vCounter[7]_i_2_n_0\
    );
\vCounter[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I3 => vCounter(6),
      I4 => vCounter(4),
      O => \vCounter[7]_i_3_n_0\
    );
\vCounter[7]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\vCounter[9]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
vga_hsync_i_4: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => hCounter(2),
      I1 => hCounter(1),
      I2 => vga_hsync_i_5_n_0,
      I3 => vga_hsync_i_3_n_0,
      I4 => hCounter(4),
      I5 => hCounter(3),
      O => vga_hsync_i_4_n_0
    );
vga_hsync_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CameraIP_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[2]_i_1\ : label is "soft_lutpair54";
  ...
  attribute SOFT_HLUTNM of \slv_reg1[31]_i_2\ : label is "soft_lutpair55";
begin
