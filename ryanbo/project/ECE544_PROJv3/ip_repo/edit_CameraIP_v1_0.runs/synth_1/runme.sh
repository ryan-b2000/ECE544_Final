...
HD_PWD='C:/Users/Public/Vivado/ECE544_PROJv3/ip_repo/edit_CameraIP_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CameraIP_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CameraIP_v1_0.tcl
