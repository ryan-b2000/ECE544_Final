...
HD_PWD='C:/Users/Public/Vivado/ECE544_PROJv3/ip_repo/edit_CameraIP_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CameraIP_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CameraIP_v1_0.tcl -notrace
