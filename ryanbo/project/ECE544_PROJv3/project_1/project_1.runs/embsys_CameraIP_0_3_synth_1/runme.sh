...
HD_PWD='C:/Users/Public/Vivado/ECE544_PROJv3/project_1/project_1.runs/embsys_CameraIP_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_CameraIP_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_CameraIP_0_3.tcl
