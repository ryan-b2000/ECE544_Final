...
HD_PWD='C:/Users/Public/Vivado/ECE544_PROJv3/project_1/project_1.runs/embsys_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_blk_mem_gen_0_0.tcl
